  ...
  return (
    <div className="bg-white mt-8 flex flex-col rounded-[14px]">
      <div className="flex items-center justify-between p-5">
        <h4 className="text-2xl font-semibold">Feedbacks</h4>
        <div
          ...
          {new Array(4).fill(" ").map((_, index) => (
            <tr key={index} className="border-b border-[#EEEEEE]">
              ...
              <td className=" gap-x-2 flex  py-4 pr-5  items-center justify-center">
                <button className="bg-[#1E6F6D] w-8 h-8 rounded-lg flex items-center justify-center ">
                  <img src="/icons/chat.svg" alt="" className="w-4" />
                </button>
                <button className="bg-[#CC3333] w-8 h-8 rounded-lg flex items-center justify-center ">
                  <img src="/icons/remove.svg" alt="" className="w-4" />
                </button>
              </td>
            </tr>
          ))}
